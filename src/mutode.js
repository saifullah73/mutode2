...
class Mutode {
  ...
  async run () {
    ...
    try {
      ...
      console.log(`Timeout = ${chalk.bgCyan(this.timeout/1000)}`);
  ...
  async timeCleanTests () {
    ...
    /*
    This is new code written as part of research $$new
    */
    var failedTestCasesNumber = 1;
    var testCaseNo = 0;
    var header = "mutant-id|timeToExecute"; // starting of header row
    /*
    orignial code starting
    */
      ...
      var output,match,regex1,regex2,match2,testCaseName,lines;
        ...
        lines.forEach((element, index) => {
          ...
          if (match){
            ...
            header = header + "|" + testCaseNo + "-" + testCaseName;
            testCaseNo++;
